...
// Configure trace exporter with more options - use OTLP gRPC endpoint
...
// IMPORTANT: The HTTP exporter expects the base URL without /v1/metrics
const metricExporterUrl = otlpHttpEndpoint || otlpEndpoint.replace(':4317', ':4318');
console.log('Metric exporter URL:', metricExporterUrl);
...
try {
  ...
  // without trying to handle it as a Promise
  sdk.start();
