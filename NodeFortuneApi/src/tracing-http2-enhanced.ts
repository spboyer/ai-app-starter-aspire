// OpenTelemetry instrumentation with HTTP/2 protocol for Node.js API
...
try {
  ...
  http2GrpcSession.on('error', (err: Error) => {
...
function shutdown(): void {
  ...
  sdk.shutdown()
    ...
    .catch((err: Error) => console.error('❌ Error shutting down OpenTelemetry SDK:', err))
    .finally(() => {
